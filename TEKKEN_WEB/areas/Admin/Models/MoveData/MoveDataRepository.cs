...
{
    public class MoveDataRepository : BaseCharacterRepository, IMoveDataRepository
    {
        private ILogger<MoveDataRepository> _logger;
        private ITranslateNameRepository _translateNameRepository;

        public MoveDataRepository(IConfiguration config, ILogger<MoveDataRepository> logger, IHttpContextAccessor httpContextAccessor, ITranslateNameRepository translateNameRepository) : base(config, logger, httpContextAccessor)
        {
            _logger = logger;
        ...
        public List<MoveData> GetAllList(BaseType baseType, int character_code) => con.Query<MoveData>("[MoveData_GetAllList]", new { character_code = character_code }, commandType: CommandType.StoredProcedure).ToList();
        ...
        protected int SaveOrUpdate(MoveData moveData, FormType formType)
        {
            ...
            parameters.Add("@startFrame_Display", value: moveData.StartFrame_Display, dbType: DbType.String);
            ...
            parameters.Add("@guardFrame_Display", value: moveData.GuardFrame_Display, dbType: DbType.String);
            ...
            parameters.Add("@HITFrame_Display", value: moveData.HitFrame_Display, dbType: DbType.String);
            ...
            parameters.Add("@counterFrame_Display", value: moveData.CounterFrame_Display, dbType: DbType.String);
